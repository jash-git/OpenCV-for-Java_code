...
public class Ch11_6_1FlannBaseAndHomography {
	...
	public Mat Features2D(){
	    ...
	    Mat img_object = Imgcodecs.imread(object_filename, Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE); // 0 =
	                                                            // CV_LOAD_IMAGE_GRAYSCALE
	    Mat img_scene = Imgcodecs.imread(scene_filename, Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);

	    FeatureDetector detector = FeatureDetector.create(1); // 4 = SURF
	    ...
	    DescriptorExtractor extractor = DescriptorExtractor.create(1); 
