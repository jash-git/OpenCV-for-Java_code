...
public class Ch07_14_2PolylineWithMouseControl {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch07_14_2PolylineWithMouseControl window = new Ch07_14_2PolylineWithMouseControl();
	 ...
	 */
	public Ch07_14_2PolylineWithMouseControl() {
		initialize();
	}
