...
public class Ch10_20_2FitLine {
        ...
        private void initialize() {
                final Mat source =  new Mat(512, 512, CvType.CV_8UC3,new Scalar(255,255,255));
                ...
                slider_cth1.addChangeListener(new ChangeListener() {
                        public void stateChanged(ChangeEvent arg0) {
                        	if(slider_cth1.getValue()==3){
                                ...
                                BufferedImage newImage=matToBufferedImage(FindFitLine(normalDistubitionMat,slider_cth1.getValue()));
 ...
 public Mat FindFitLine(Mat data,int  distType){
		...
		try {
			if (v0 != 0) {
				...
				Imgproc.line(source, new Point(source.cols() - 1, right),	new Point(0, left), new Scalar(0, 0, 0),2);
			}
