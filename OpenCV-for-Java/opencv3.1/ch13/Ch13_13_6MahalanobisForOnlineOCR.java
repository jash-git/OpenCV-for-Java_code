...
public class Ch13_13_6MahalanobisForOnlineOCR {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch13_13_6MahalanobisForOnlineOCR window = new Ch13_13_6MahalanobisForOnlineOCR();
	 ...
	 */
	public Ch13_13_6MahalanobisForOnlineOCR() {
		initialize();
	}
