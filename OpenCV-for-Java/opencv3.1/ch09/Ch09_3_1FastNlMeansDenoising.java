...
public class Ch09_3_1FastNlMeansDenoising {
	...
	public static void main(String args[]){
		...
		Mat img = Imgcodecs.imread("C://opencv3.1//samples//lena-gray.jpg",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);	
		Photo.fastNlMeansDenoising(im, im);
		Imgcodecs.imwrite("C://opencv3.1//samples//fastNlMeansDenoising_lena.jpg", im);	
		Imgcodecs.imwrite("C://opencv3.1//samples//fastNlMeansDenoising_lena-gray.jpg", img);	
	}
}
