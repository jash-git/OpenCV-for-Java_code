...
public class Ch10_21_3FindBrokenByBoundingRect {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch10_21_3FindBrokenByBoundingRect window = new Ch10_21_3FindBrokenByBoundingRect();
	...
	public Mat BoundingRect(){
		...
		Mat source = Imgcodecs.imread("C://opencv3.1//samples//IMAG0424.jpg",Imgcodecs.CV_LOAD_IMAGE_COLOR);
