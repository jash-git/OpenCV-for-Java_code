...
public class Ch10_13_3ColorPickerForImg {
	...
	private void initialize() {
		final Mat source = Imgcodecs.imread("C://opencv3.1//samples//DSC_0773.jpg");
		...
		lblNewLabel.setBounds(10, 78, 564, 292);
		lblNewLabel.setIcon(new ImageIcon(image));
		frmjavaSwing.getContentPane().add(lblNewLabel);
		
		final JLabel lbl_Rvalue = new JLabel("");
		lbl_Rvalue.setBounds(34, 18, 46, 15);
		frmjavaSwing.getContentPane().add(lbl_Rvalue);
		
		final JLabel lbl_Hvalue = new JLabel("");
