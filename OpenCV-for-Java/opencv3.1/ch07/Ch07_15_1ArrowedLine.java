...
public class Ch07_15_1ArrowedLine {
	...
	private void initialize() {
		...
		lblNewLabel.setBounds(5, 10, 354, 315);
		 ...
		 for (int angle = 0; angle < 360; angle += 15)
		   {
		     double angleRad = angle*Math.PI / 180.0;   // convert angle to radians
		      ...
		      Imgproc.arrowedLine(source, new Point(center.x +direction.x*0.2,center.y +direction.y*0.2), new Point(center.x +direction.x*0.6,center.y +direction.y*.6), new Scalar(255, angle, 0), thickness, lineType, 0, tipLength); // draw arrow!
