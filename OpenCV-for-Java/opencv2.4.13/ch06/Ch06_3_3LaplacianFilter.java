...
public class Ch06_3_3LaplacianFilter {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch06_3_3LaplacianFilter window = new Ch06_3_3LaplacianFilter();
	 ...
	 */
	public Ch06_3_3LaplacianFilter() {
		initialize();
	}
	...
	private void initialize() {
		...
		final Mat temp=new Mat(source.rows(),source.cols(),source.type());
		Imgproc.cvtColor(source, temp, Imgproc.COLOR_RGB2GRAY); 
		BufferedImage image=matToBufferedImage(temp);
		
		frmjavaSwing = new JFrame();
		frmjavaSwing.setTitle("opencv Laplacian¦Ç¶¥¼v¹³½m²ß");
