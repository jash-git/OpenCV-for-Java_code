		 ...
		 for (int angle = 0; angle < 360; angle += 15)
		   {
		     double angleRad = angle*Math.PI / 180.0;   // convert angle to radians
		      ...
		      Core.arrowedLine(source, new Point(center.x +direction.x*0.5,center.y +direction.y*0.5), new Point(center.x +direction.x,center.y +direction.y), new Scalar(255, angle, 0), thickness, lineType, 0, tipLength); // draw arrow!
