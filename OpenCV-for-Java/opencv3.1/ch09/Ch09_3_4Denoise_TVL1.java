...
public class Ch09_3_4Denoise_TVL1 {
	...
	private void initialize() {
		final Mat source = Imgcodecs.imread("C://opencv3.1//samples//lena.jpg",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
	...
	public Mat Denoise(Mat source,int lambda,int niters){
		Mat im = Imgcodecs.imread("C://opencv3.1//samples//lena.jpg",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
		Mat im1 = Imgcodecs.imread("C://opencv3.1//samples//lena1.jpg",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
		Mat im2 = Imgcodecs.imread("C://opencv3.1//samples//lena2.jpg",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
