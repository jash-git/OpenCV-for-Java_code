...
public class Ch05_16_1AddBoard {
	...
	public Ch05_16_1AddBoard() {
		initialize();
		System.out.println("Imgproc.BORDER_CONSTANT="+Imgproc.BORDER_CONSTANT);
		System.out.println("Imgproc.BORDER_REPLICATE="+Imgproc.BORDER_REPLICATE);
		System.out.println("Imgproc.BORDER_TRANSPARENT="+Imgproc.BORDER_TRANSPARENT);
		System.out.println("Imgproc.BORDER_WRAP="+Imgproc.BORDER_WRAP);
		System.out.println("Imgproc.BORDER_DEFAULT="+Imgproc.BORDER_DEFAULT);
		System.out.println("Imgproc.BORDER_ISOLATED="+Imgproc.BORDER_ISOLATED);
		System.out.println("Imgproc.BORDER_REFLECT="+Imgproc.BORDER_REFLECT);
		System.out.println("Imgproc.BORDER_REFLECT101="+Imgproc.BORDER_REFLECT101);
		System.out.println("Imgproc.BORDER_REFLECT_101="+Imgproc.BORDER_REFLECT_101);
	}
	...
	public Mat AddBoard(float borderSize,int borderType){
		 ...
		 Mat destination=new Mat(source.rows(),source.cols(),source.type());
			...
			destination=source;
			Imgproc.copyMakeBorder(source, destination, (int)top, (int)bottom, (int)left, (int)right, borderType);
		return destination;
