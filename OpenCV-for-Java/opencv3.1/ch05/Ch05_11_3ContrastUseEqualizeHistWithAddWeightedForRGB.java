...
public class Ch05_11_3ContrastUseEqualizeHistWithAddWeightedForRGB {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch05_11_3ContrastUseEqualizeHistWithAddWeightedForRGB window = new Ch05_11_3ContrastUseEqualizeHistWithAddWeightedForRGB();
	 ...
	 */
	public Ch05_11_3ContrastUseEqualizeHistWithAddWeightedForRGB() {
		initialize();
	}
