...
public class Mahalanobis6 {
	...
	public static void main(String[] args) {
		...
		Mat temp0=Highgui.imread("C://opencv3.1//samples//ocr//number4.jpg",Highgui.CV_LOAD_IMAGE_GRAYSCALE);
		...
		for(int i=0;i<10;i++){
			String tempFileNamw="";
					...
					source = Highgui.imread("C://opencv3.1//samples//ocr//"+i+"0.jpg",Highgui.CV_LOAD_IMAGE_GRAYSCALE);
