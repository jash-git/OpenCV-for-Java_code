...
//可考慮太近的2綠點第2個不採信
public class Ch10_18_3FindFingerViaPalmCenterByWebCam2 {
	static {
			...
			while (true) {
				...
				if (!webcam_image.empty()) {
					...
					if (R > 22) {
						...
						Core.circle(firstArea, new Point(centerX ,centerY), R, new Scalar(255, 0, 0));
						Core.line(firstArea, new Point(centerX ,centerY ), new Point(centerX,centerY ), new Scalar(255,0, 0), 5);
						
						Core.putText(firstArea, "("+centerX+","+centerY+")", new Point(centerX ,centerY ), 0, 0.3, new Scalar(255, 0, 0));//顯示掌心座標
				 	              ...
				 	              if (tempContour.get(index2, 0)!=null) { 
					                 ...
					                 for(int j = 0; j < mConvexityDefectsMatOfInt4.size().height -1 ; j++){
					                    ...
					                    //若是空,第1點收入
					                     if(CorrectPt1.isEmpty()){
					                    	 CorrectPt1.add(pt1);
					                     }else if(CorrectPt1.size()==1){//若是判斷左/右手,大/小姆指可能會有很多綠點,連續綠點只有最後
					                    	 //1個綠點是真指尖,當只有收錄1點時
					                    	double tempDistance=getDistance(pt1,(Point)CorrectPt1.get(0)); 
					                    	  if (tempDistance>0 && tempDistance<20){//若很近
					                     ...
					                     **/
					                     ...
					                     Core.line(firstArea, pt3, pt3, new Scalar(150, 155, 255), 12);//底dot,粉紅
					                   	 ...
					                   	 //pt1 需在框內,pt1必需在掌心上
//					                   	 if((pt1.x>30 && pt1.x<300)&&(pt1.y>90 && pt1.y<420 )&&(centerY-pt1.y>60) ){
//					                   	//掌心至指尖連線
//					                   		Core.line(firstArea, pt1,new Point(centerX ,centerY ), new Scalar(255,0, 0), 3);
//					                   	 }
					                   	
					                   	 for(int kk=0;kk<CorrectPt1.size();kk++){
					                   		 
					                   		Core.line(firstArea, CorrectPt1.get(kk),new Point(centerX ,centerY ), new Scalar(255,0, 0), 2);
...
//					                    	 //if((centerY-pt1.y>60) ){
//						                   	//掌心至指底連線
//						                   		Core.line(firstArea, pt1,new Point(centerX ,centerY ), new Scalar(255,0, 0), 2);
//						                   	 }  
					                  ...
					                  /**  	 
					                    	 //pt3 需在框內,pt1必需在掌心上
						                   	 //if((pt3.x>30 && pt3.x<300)&&(pt3.y>90 && pt3.y<420 )&&(centerY-pt3.y>30)&&(centerY-pt3.y<50) ){
						                   		 if((pt3.x>30 && pt3.x<300)&&(pt3.y>90 && pt3.y<420 )&&(centerY-pt3.y>0)&&(centerY-pt3.y<50) ){
					                    	 //if((centerY-pt1.y>60) ){
						                   	//掌心至指底連線
						                   		Core.line(firstArea, pt3,new Point(centerX ,centerY ), new Scalar(255,0, 0), 2);
						                   	 }
					                    	 
						                		 if((old_pt3.x>30 && old_pt3.x<300)&&(old_pt3.y>90 && old_pt3.y<420 )&&(centerY-old_pt3.y>0)&&(centerY-old_pt3.y<50) ){
							                    	 //if((centerY-pt1.y>60) ){
								                   	//掌心至指底連線
								                   		Core.line(firstArea, old_pt3,new Point(centerX ,centerY ), new Scalar(255,0, 0), 2);
								                   	 }
						                **/
						...
						System.out.println(" CorrectPt1="+ CorrectPt1.size());
