   ...
   public class Ch09_4_1HDR {
      public static void main( String[] args )
      {
         try{
            ...
            Mat source1 = Imgcodecs.imread("C://opencv3.1//samples//HDRmantis1.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
            Mat source2 = Imgcodecs.imread("C://opencv3.1//samples//HDRmantis2.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
            Mat source3 = Imgcodecs.imread("C://opencv3.1//samples//HDRmantis3.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
            Mat source4 = Imgcodecs.imread("C://opencv3.1//samples//HDRmantis4.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
            Mat source5 = Imgcodecs.imread("C://opencv3.1//samples//HDRmantis5.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
            Mat source6 = Imgcodecs.imread("C://opencv3.1//samples//HDRmantis6.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
            Mat source7 = Imgcodecs.imread("C://opencv3.1//samples//HDRmantis7.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
...
//          alignMTB.process(listMat, alignMTBMatList, times, response);
         ...
         //Write results         
          Imgcodecs.imwrite("C://opencv3.1//samples//CalibrateDebevec-mantis-ldr.jpg", ldr);
          Imgcodecs.imwrite("C://opencv3.1//samples//CalibrateDebevec-mantis-ldrRobertson.jpg",    ldrRobertson);
       
          Imgcodecs.imwrite("C://opencv3.1//samples//CalibrateDebevec-mantis-fusion.jpg", fusion);
          Imgcodecs.imwrite("C://opencv3.1//samples//CalibrateDebevec-mantis-mergeRobertsonMat.jpg", mergeRobertsonMat);
          
          //Imgcodecs.imwrite("C://opencv3.1//samples//CalibrateDebevec-hdr.hdr", hdr);
          Imgcodecs.imwrite("C://opencv3.1//samples//CalibrateDebevec-mantis-tonemapMat.jpg", tonemapMat);
          Imgcodecs.imwrite("C://opencv3.1//samples//CalibrateDebevec-mantis-tonemapDragoMat.jpg", tonemapDragoMat);
          Imgcodecs.imwrite("C://opencv3.1//samples//CalibrateDebevec-mantis-tonemapMantiukMat.jpg", tonemapMantiukMat);
          Imgcodecs.imwrite("C://opencv3.1//samples//CalibrateDebevec-mantis-tonemapReinhardMat.jpg",  tonemapReinhardMat);
