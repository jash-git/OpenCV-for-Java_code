...
public class Ch05_9_3RotateUseGetRotationMatrix2D {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch05_9_3RotateUseGetRotationMatrix2D window = new Ch05_9_3RotateUseGetRotationMatrix2D();
	...
	private void initialize() {
		...
		slider_Angle.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				...
				BufferedImage newImage=matToBufferedImage(rotate(source,slider_Angle.getValue(),(float)slider_scale.getValue()/10));
