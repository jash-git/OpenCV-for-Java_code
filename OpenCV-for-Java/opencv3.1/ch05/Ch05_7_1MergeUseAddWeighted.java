...
public class Ch05_7_1MergeUseAddWeighted {
	...
	private void initialize() {
		...
		final Mat source2 = Imgcodecs.imread("C://opencv3.1//samples//baboon.jpg");
		
		BufferedImage image=matToBufferedImage(merge(source1,source2,alpha,beta,gamma));
		...
		slider_Alpha.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				...
				BufferedImage newImage=matToBufferedImage(merge(source1,source2,(float)slider_Alpha.getValue()/10,(float)slider_Beta.getValue()/10,slider_Gamma.getValue()));
