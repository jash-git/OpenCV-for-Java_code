...
public class Ch11_2_1CornerHarrisStephens {
	...
	private void initialize() {
		...
		slider_ks.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				...
				BufferedImage newImage=matToBufferedImage(Harris(slider_bs.getValue(),slider_ks.getValue(),(float)slider_k.getValue()/100));
	...
	public Mat Harris(int blockSize, int ksize, double k){
		...
		Mat destination=source.clone();
         ...
         Core.normalize(destination, destination, 0, 255, Core.NORM_MINMAX, CvType.CV_32FC1,new Mat());
