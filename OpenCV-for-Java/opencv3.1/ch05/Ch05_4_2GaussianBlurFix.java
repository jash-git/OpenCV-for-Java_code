...
public class Ch05_4_2GaussianBlurFix {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch05_4_2GaussianBlurFix window = new Ch05_4_2GaussianBlurFix();
	 ...
	 */
	public Ch05_4_2GaussianBlurFix() {
		initialize();
	}
	...
	private void initialize() {
		...
		BufferedImage image=matToBufferedImage(BlurFilter(source,GaussianKernelSize));
