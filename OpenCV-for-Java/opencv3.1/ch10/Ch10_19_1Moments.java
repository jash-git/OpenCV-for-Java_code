...
public class Ch10_19_1Moments {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch10_19_1Moments window = new Ch10_19_1Moments();
	...
	private void initialize() {
		  Mat source = Imgcodecs.imread("C://opencv3.1//samples//moment-test1.png",
				  Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
		  BufferedImage image=matToBufferedImage(source);
		
		
		frmRr = new JFrame();
		frmRr.setTitle("空間矩、中心矩、標準中心矩及不變矩");
	...
	public Mat findContours(int i){
	      Mat source = Imgcodecs.imread("C://opencv3.1//samples//moment-test1.png",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
        ...
        Imgproc.HuMoments(moments, Hu);
         ...
         System.out.println("驗證第1階Hu不變矩= " + (moments.get_nu20()+moments.get_nu02()));//0
         
        
         //繪出質心
         Point center=new Point(moments.get_m10()/moments.get_m00(),moments.get_m01()/moments.get_m00());
         System.out.println("質心座標= (" + moments.get_m10()/moments.get_m00()+","+moments.get_m01()/moments.get_m00()+")");//0
         Imgproc.circle(drawing, center, 2, new Scalar(0,255,0),-1);
