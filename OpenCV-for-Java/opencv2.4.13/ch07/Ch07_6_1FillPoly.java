...
public class Ch07_6_1FillPoly {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch07_6_1FillPoly window = new Ch07_6_1FillPoly();
	...
	public Mat paint(){
		...
		Core.fillPoly(source, allMatOfPoint, new Scalar(255,0,0));
		allMatOfPoint.add(mop2);
		 Core.fillPoly(source, allMatOfPoint, new Scalar(0,255,0));
		return source;
	}
