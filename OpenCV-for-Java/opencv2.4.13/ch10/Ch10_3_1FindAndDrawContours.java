...
public class Ch10_3_1FindAndDrawContours {
	...
	public Ch10_3_1FindAndDrawContours() {
		...
		System.out.println("Imgproc.Imgproc.RETR_LIST="+Imgproc.RETR_LIST);
	...
	private void initialize() {
		final Mat source = Highgui.imread("C://opencv3.1//samples//airplane.jpg");
	...
	public Mat FindAndDrawContours(double threshold1){
		Mat source = Highgui.imread("C://opencv3.1//samples//airplane.jpg",Highgui.CV_LOAD_IMAGE_GRAYSCALE); 
