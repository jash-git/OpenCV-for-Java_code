...
public class Ch10_20_1FitLine {
        ...
        private void initialize() {
                final Mat source = Imgcodecs.imread("C://opencv3.1//samples//fitline_test1.jpg");
                ...
                slider_cth1.addChangeListener(new ChangeListener() {
                        public void stateChanged(ChangeEvent arg0) {
                                ...
                                BufferedImage newImage=matToBufferedImage(FindFitLine(slider_cth1.getValue(),slider_distType.getValue()));
 ...
 public Mat FindFitLine(double threshold1,int distType){
		Mat source = Imgcodecs.imread("C://opencv3.1//samples//fitline_test1.jpg",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
		...
		try {
			if (v0 != 0) {
				...
				Imgproc.line(srcClone, new Point(source.cols() - 1, right),	new Point(0, left), new Scalar(255, 255, 50));
			}
