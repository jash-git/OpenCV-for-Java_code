...
public class Ch13_10_4AnnForOnlineOCR {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch13_10_4AnnForOnlineOCR window = new Ch13_10_4AnnForOnlineOCR();
	 ...
	 */
	public Ch13_10_4AnnForOnlineOCR() {
		initialize();
	}
	...
	private void initialize() {
		...
		final ANN_MLP ann=ANN_MLP.create();
...
//			ann.setRpropDWMax(50);
		...
		boolean r=ann.train(ocr.getTrainingDataMat(), Ml.ROW_SAMPLE, ocr.getTrainingLabelsFloatMat());
...
//				System.out.println(t.dump());//ok
				 ...
				 float result=ann.predict(ocr.handleForML(getGlobalMat()));
