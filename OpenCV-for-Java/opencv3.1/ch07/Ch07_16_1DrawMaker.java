...
public class Ch07_16_1DrawMaker {
	...
	public Ch07_16_1DrawMaker() {
		...
		System.out.println("Imgproc.MARKER_TILTED_CROSS="+Imgproc.MARKER_TILTED_CROSS);
		System.out.println("Imgproc.MARKER_TRIANGLE_DOWN="+Imgproc.MARKER_TRIANGLE_DOWN);
	...
	public Mat paint(int marker){
		 ...
		 Imgproc.drawMarker(source, new Point(230,250), new Scalar(20,105,66),  marker, 20, 3, 8);
