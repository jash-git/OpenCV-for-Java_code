...
public class Ch10_3_2ShowContours {
	...
	private void initialize() {
		...
		slider_jpg.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				...
				BufferedImage newImage=matToBufferedImage(findContours(slider_jpg.getValue(),slider_mode.getValue(),slider_method.getValue()));
	...
	public Mat findContours(int i,int mode,int method){
	    	...
	    	Mat source = Imgcodecs.imread("C://opencv3.1//samples//ContoursTest.png",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
