	      ...
	      {  
	        ...
	        if( !webcam_image.empty() )  
	         {  
				...
				Imgproc.circle(webcam_image, statePt, 5,new Scalar(255,0,0),2);//former point,Blue
				Imgproc.circle(webcam_image, predictPt, 5, new Scalar(0,255,0),2);//predict point,Green
