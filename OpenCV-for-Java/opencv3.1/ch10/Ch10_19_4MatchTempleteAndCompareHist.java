...
public class Ch10_19_4MatchTempleteAndCompareHist {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch10_19_4MatchTempleteAndCompareHist window = new Ch10_19_4MatchTempleteAndCompareHist();
	...
	private void initialize() {
		...
		lblNewLabel_ladybug.setIcon(new ImageIcon("C://opencv3.1//samples//ladybug.jpg"));
		...
		slider_method2.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				...
				BufferedImage newImage=matToBufferedImage(findTemplete(src,template,slider_method2.getValue()));
