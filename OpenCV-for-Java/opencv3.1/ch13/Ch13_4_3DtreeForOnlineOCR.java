...
public class Ch13_4_3DtreeForOnlineOCR {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch13_4_3DtreeForOnlineOCR window = new Ch13_4_3DtreeForOnlineOCR();
	 ...
	 */
	public Ch13_4_3DtreeForOnlineOCR() {
		initialize();
	}
...
final DTrees dtree=DTrees.create();//創建dtree
...
dtree.setCVFolds(0);//交叉驗證,//set 10,it will get Exception in thread "main" java.lang.Exception: unknown exception
dtree.setTruncatePrunedTree(true);
		...
		JButton btnMLpredict = new JButton("決策樹預測");
...
//				System.out.println(t.dump());//ok
				 ...
				 float result=dtree.predict(ocr.handleForML(getGlobalMat()));
