...
public class Ch07_3_1DrawCircle {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch07_3_1DrawCircle window = new Ch07_3_1DrawCircle();
	...
	public Mat paint(){
		 ...
		 Core.circle(source,pt1,58,new Scalar(255,55,220),-1);
		return source;
	}
