...
public class Ch05_1_2BrightnessUseConvertToWithGUI {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch05_1_2BrightnessUseConvertToWithGUI window = new Ch05_1_2BrightnessUseConvertToWithGUI();
	...
	private void initialize() {
		...
		final JSlider slider_dark_alpha = new JSlider();
		...
		final JLabel label_dark_beta = new JLabel("50");
		...
		slider_alpha.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				...
				BufferedImage newImage=matToBufferedImage(matConvertTo(source,slider_alpha.getValue(),slider_beta.getValue()));
		...
		slider_dark_alpha.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				...
				BufferedImage newImage=matToBufferedImage(matConvertTo(source,(float)slider_dark_alpha.getValue()/10,0-slider_dark_beta.getValue()));
				lblNewLabel.setIcon(new ImageIcon(newImage));
			}
		});
