...
public class Ch09_10_1EdgePreservingFilter {
	...
	private void initialize() {
		...
		slider_sigmaR.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				...
				BufferedImage newImage=matToBufferedImage(EdgePreservingFilter(slider_flags.getValue(),slider_sigmaS.getValue(),(float)slider_sigmaR.getValue()/10));
	...
	public Mat EdgePreservingFilter(int flags,float sigma_s ,float sigma_r ){
		Mat src = Imgcodecs.imread("C://opencv3.1//samples//lena.jpg",Imgcodecs.CV_LOAD_IMAGE_COLOR);
