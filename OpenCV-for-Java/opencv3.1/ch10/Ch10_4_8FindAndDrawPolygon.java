...
public class Ch10_4_8FindAndDrawPolygon {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch10_4_8FindAndDrawPolygon window = new Ch10_4_8FindAndDrawPolygon();
	 ...
	 */
	public Ch10_4_8FindAndDrawPolygon() {
		initialize();
	}
	...
	private void initialize() {
		final Mat source = Imgcodecs.imread("C://opencv3.1//samples//palm_p.jpg");
		
		BufferedImage image=matToBufferedImage(source);
		
		frmjavaSwing = new JFrame();
		frmjavaSwing.setTitle("opencv 尋找輪廓並且繪出最似外框多邊形");
	...
	public Mat FindAndDrawPolygon(double threshold1){
		Mat source = Imgcodecs.imread("C://opencv3.1//samples//palm_p.jpg",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE); 
