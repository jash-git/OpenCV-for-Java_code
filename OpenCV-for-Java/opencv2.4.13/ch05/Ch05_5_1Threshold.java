...
public class Ch05_5_1Threshold {
	...
	private void initialize() {
		...
		BufferedImage image=matToBufferedImage(threshold(source,thresh,maxval,type));
		...
		slider_Threshold.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				...
				BufferedImage newImage=matToBufferedImage(threshold(source,slider_Threshold.getValue(),slider_Maxval.getValue(),slider_type.getValue()));
