...
public class Ch06_2_1PrewittFilter {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch06_2_1PrewittFilter window = new Ch06_2_1PrewittFilter();
	...
	public Mat Convolution(Mat source,int type){
		...
		//Imgproc.sepFilter2D(source, destination, -1, kernel,new Mat());
		return destination;
