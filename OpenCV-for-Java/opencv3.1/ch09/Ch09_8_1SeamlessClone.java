...
public class Ch09_8_1SeamlessClone {
	public static void main(String[] args) {
		...
		Mat src1 = Imgcodecs.imread("C://opencv3.1//samples//monster.jpg",Imgcodecs.CV_LOAD_IMAGE_COLOR);
		Mat dst1 = Imgcodecs.imread("C://opencv3.1//samples//DSCN3629s.jpg",Imgcodecs.CV_LOAD_IMAGE_COLOR);
		
		Mat src2 = Imgcodecs.imread("C://opencv3.1//samples//monster-bg-less.jpg",Imgcodecs.CV_LOAD_IMAGE_COLOR);
		    
		Mat src3 = Imgcodecs.imread("C://opencv3.1//samples//IloveOpencv-s.jpg",Imgcodecs.CV_LOAD_IMAGE_COLOR);
		Mat dst3 = Imgcodecs.imread("C://opencv3.1//samples//wood2.jpg",Imgcodecs.CV_LOAD_IMAGE_COLOR);
		
		Mat src4 = Imgcodecs.imread("C://opencv3.1//samples//IloveOpencv-bg-gray.jpg",Imgcodecs.CV_LOAD_IMAGE_COLOR);
...
//	        }
		...
		System.out.println("Photo.MIXED_CLONE="+Photo.MIXED_CLONE);
		 ...
		 // Save results
		 Imgcodecs.imwrite("C://opencv3.1//samples//SeamlessClone-normalClone-LakeMonster.jpg", normal_clone1);
		 Imgcodecs.imwrite("C://opencv3.1//samples//SeamlessClone-MixedClone-LakeMonster.jpg", mixed_clone1);
		 
		 Imgcodecs.imwrite("C://opencv3.1//samples//SeamlessClone-normalClone-LakeMonster-bgLess.jpg", normal_clone2);
		 Imgcodecs.imwrite("C://opencv3.1//samples//SeamlessClone-MixedClone-LakeMonster-bgLess.jpg", mixed_clone2);

		 Imgcodecs.imwrite("C://opencv3.1//samples//SeamlessClone-normalClone-iloveCv.jpg", normal_clone3);
		 Imgcodecs.imwrite("C://opencv3.1//samples//SeamlessClone-MixedClone-iloveCv.jpg", mixed_clone3);
		 
		 Imgcodecs.imwrite("C://opencv3.1//samples//SeamlessClone-normalClone-iloveCv2.jpg", normal_clone4);
		 Imgcodecs.imwrite("C://opencv3.1//samples//SeamlessClone-MixedClone-iloveCv2.jpg", mixed_clone4);
	}
