...
public class Ch08_5_3ShowCartoonByWebCam {
	...
	public static Mat BlurAndCanny(Mat source,double threshold1,double threshold2,int GaussianKernelSize,int ksize,int op){
	...
	public static Mat Merge(Mat source1,Mat source2,double alpha,double beta,double gamma){
