...
//		labelsMat.put(3, 0, labels[3]);
		...
		params.set_term_crit(new TermCriteria(TermCriteria.MAX_ITER|TermCriteria.EPS, 100, 1E-6));
		...
		boolean r=rtree.train(trainingDataMat, tflag, labelsMat,new Mat(),new Mat(),new Mat(),new Mat(),params);
