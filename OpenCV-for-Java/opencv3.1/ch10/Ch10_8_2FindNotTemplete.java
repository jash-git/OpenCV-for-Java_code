...
public class Ch10_8_2FindNotTemplete {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch10_8_2FindNotTemplete window = new Ch10_8_2FindNotTemplete();
	 ...
	 */
	public Ch10_8_2FindNotTemplete() {
		initialize();
	...
	private void initialize() {
		...
		lblNewLabel_2.setIcon(new ImageIcon("C://opencv3.1//samples//ladybug.jpg"));
