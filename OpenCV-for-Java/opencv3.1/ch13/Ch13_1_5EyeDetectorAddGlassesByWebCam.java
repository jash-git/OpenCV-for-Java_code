...
public class Ch13_1_5EyeDetectorAddGlassesByWebCam {
	...
	public static void main(String arg[]) {
		...
		Mat eyeglasses = Imgcodecs.imread("C://opencv3.1//samples//eyeglasses.jpg",Imgcodecs.CV_LOAD_IMAGE_COLOR);
			...
			while (true) {
				...
				if( !webcam_image.empty() ){
					...
					//	System.out.println("oWidth="+oWidth+",oHeight="+oHeight); 
						...
						//把小圖copy到大圖
						 Rect roi=new Rect((int)(rect.x-rect.width*0.3),(int)(rect.y - rect.height*0.3),oWidth,oHeight);
