...
public class Ch10_14_3CalculateRustArea {
	...
	private void initialize() {
		final Mat source = Highgui.imread("C://opencv3.1//samples//DSC_0869.jpg");
	...
	public Mat matConvertTo(double Hmin,double Hmax,double Smin,double Smax,double Vmin,double Vmax){
		 Mat source2 = Highgui.imread("C://opencv3.1//samples//DSC_0869.jpg");
         ...
         System.out.println("生鏽面積大約:"+(float)(rust*100)/(thresholded.rows()*thresholded.cols())+"%");
