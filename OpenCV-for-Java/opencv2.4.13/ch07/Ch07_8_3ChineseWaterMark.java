...
public class Ch07_8_3ChineseWaterMark {
	...
	private void initialize() throws IOException {
		 Mat source =  Highgui.imread("C://opencv3.1//samples//DSC_0597.jpg");
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if (image!=null){
					try {
						ImageIO.write(image, "png", new File("C://opencv3.1//samples//DSC_0597_watremark.png"));
					} catch (IOException e) {
	...
	public BufferedImage HandleWaterMark(float alpha){
		...
		g2d.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_ATOP, alpha));//設定透明度 
