		...
		for (int i = 0; i < image.rows(); i++){
			...
			**/
			...
			for(int ii=0;ii<5;ii++){
				Imgproc.circle(	image, new Point(trainingData[ii][0],  trainingData[ii][1]),5, new Scalar(  0,   0,   0), 1);
				Imgproc.circle(	image, new Point(trainingData[ii+5][0],  trainingData[ii+5][1]),5, new Scalar(255, 255, 255), 1);
			}	
