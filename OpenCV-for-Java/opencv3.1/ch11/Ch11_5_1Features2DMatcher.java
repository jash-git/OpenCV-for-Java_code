...
public class Ch11_5_1Features2DMatcher {
	...
	public Ch11_5_1Features2DMatcher() {
		...
		System.out.println("DescriptorExtractor.OPPONENT_AKAZE="+DescriptorExtractor.OPPONENT_AKAZE);
	...
	private void initialize() {
		final Mat source = Imgcodecs.imread("C://opencv3.1//samples//stuff.jpg",Imgcodecs.CV_LOAD_IMAGE_COLOR);
		final Mat object = Imgcodecs.imread("C://opencv3.1//samples//stuff-b.jpg",Imgcodecs.CV_LOAD_IMAGE_COLOR);
			...
			public void stateChanged(ChangeEvent arg0) {
				...
				if(slider.getValue()<8){
					lblNewLabel_2.setText(slider.getValue()+"");
					 newImage=matToBufferedImage(Features2D(slider.getValue(),slider_1.getValue()));
				}else{
					lblNewLabel_2.setText((slider.getValue()-7+1000)+"");
					 newImage=matToBufferedImage(Features2D((slider.getValue()-7+1000),slider_1.getValue()));
				}
		...
		slider_1.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				...
				BufferedImage newImage=matToBufferedImage(Features2D(slider.getValue(),slider_1.getValue()));
				lblNewLabel.setIcon(new ImageIcon(newImage));
			}
		});
	}
	public Mat Features2D(int Extractor,int Matcher){
	    ...
	    Mat img_object = Imgcodecs.imread(object_filename, Imgcodecs.CV_LOAD_IMAGE_COLOR); // 0 =
