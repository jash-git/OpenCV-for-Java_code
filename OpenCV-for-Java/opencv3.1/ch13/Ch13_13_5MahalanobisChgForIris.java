...
public class Ch13_13_5MahalanobisChgForIris {
	static {
	...
	public static void main(String[] args) {
		...
		float[][] sampleData = { 
				...
				//{5.2f,4.1f,1.5f,0.1f}//Iris-setosa
				{5.5f,4.2f,1.4f,0.2f}//Iris-setosa,13_13_2 error,修正Core.invert ok
		};// [4][4]
/*
 * 13_13_2
line1與line2的Mahalanobis距離=1.3508100839188335
line1與line3的Mahalanobis距離=1.2402116206878127
line1與line4的Mahalanobis距離=1.4148208304418088
 */
		...
		Core.calcCovarMatrix(trainingDataMat, covar, mean, Core.COVAR_ROWS | Core.COVAR_NORMAL, CvType.CV_32F);
