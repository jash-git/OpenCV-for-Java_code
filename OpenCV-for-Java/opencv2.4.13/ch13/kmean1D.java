...
//	System.out.println(clusterCount.dump());
	//System.out.println(clusterCount.dump());
		...
		Mat mat2 = new Mat(4,4,CvType.CV_32FC1);
		Mat mat3 = new Mat(4,4,CvType.CV_32FC1);
...
/**		 
	...
	**/	 
			Mat samples = mat1.reshape(1, mat1.cols() * mat1.rows());//轉1行多列的mat
		...
		for(int i=0;i<points.rows();i++){
			...
			Core.circle(draw, new Point(data1[0]*2,100), 2, colorTab[(int)data2[0]], 2);//畫出所有的點(用顏色分類)
		...
		Highgui.imwrite("C://opencv3.1//kmeans-test2.jpg", draw );
}
}
