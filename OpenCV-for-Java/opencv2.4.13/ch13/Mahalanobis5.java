	...
	public static void main(String[] args) {
		...
		for(int i=0;i<10;i++){
			String tempFileNamw="";
					...
					source = Highgui.imread("C://opencv3.1//samples//ocr//"+i+"2.jpg",Highgui.CV_LOAD_IMAGE_GRAYSCALE);
		...
		Mat temp0=Highgui.imread("C://opencv3.1//samples//ocr//number3.jpg",Highgui.CV_LOAD_IMAGE_GRAYSCALE);
