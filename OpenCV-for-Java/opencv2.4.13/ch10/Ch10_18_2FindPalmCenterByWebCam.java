			...
			while (true) {
				...
				if (!webcam_image.empty()) {
					...
					if (R > 22) {
						...
						Core.circle(webcam_image, new Point(centerX ,centerY), R, new Scalar(255, 0, 0));
						Core.line(webcam_image, new Point(centerX ,centerY ), new Point(centerX,centerY ), new Scalar(255,0, 0), 5);
						
						Core.putText(webcam_image, "("+centerX+","+centerY+")", new Point(centerX ,centerY ), 0, 0.3, new Scalar(255, 0, 0));//顯示掌心座標
					}
