...
//只能灰階
	Mat source = Highgui.imread("C://opencv3.1//samples//shape-sample1.jpg",Highgui.CV_LOAD_IMAGE_GRAYSCALE );
	...
	Highgui.imwrite("C://opencv3.1//samples//shape-sample-ok1.jpg",drawing);
