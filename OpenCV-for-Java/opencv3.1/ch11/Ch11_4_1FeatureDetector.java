...
public class Ch11_4_1FeatureDetector {
	...
	public Ch11_4_1FeatureDetector() {
		...
		System.out.println("FeatureDetector.DYNAMIC_AKAZE="+FeatureDetector.DYNAMIC_AKAZE);
		...
		System.out.println("FeatureDetector.PYRAMID_AKAZE="+FeatureDetector.PYRAMID_AKAZE);
	...
	private void initialize() {
		final Mat demo = Imgcodecs.imread("C://opencv3.1//samples//TestForFeatureDetector.jpg",Imgcodecs.CV_LOAD_IMAGE_COLOR);
	...
	public Mat FeatureDetector(int DetectorType){
		Mat source = Imgcodecs.imread("C://opencv3.1//samples//TestForFeatureDetector.jpg",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
