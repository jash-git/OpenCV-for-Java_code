...
public class Ch07_7_3SettingRoiByPolylineByBoundingRect {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch07_7_3SettingRoiByPolylineByBoundingRect window = new Ch07_7_3SettingRoiByPolylineByBoundingRect();
	 ...
	 */
	public Ch07_7_3SettingRoiByPolylineByBoundingRect() {
		initialize();
	}
