...
public class Ch07_4_1DrawEllipse {
	...
	private void initialize() {
		...
		frmjavaSwing.setTitle("opencv µe¾ò¶ê½m²ß");
	...
	public Mat paint(){
		 ...
		 Imgproc.ellipse(source,pt1,new Size(16,16),158,0,360,new Scalar(255,55,220),3);
		 pt1=new Point(80,80);
		 Imgproc.ellipse(source,pt1,new Size(13,30),10,0,360,new Scalar(255,0,0),3);
		 pt1=new Point(110,110);
		 Imgproc.ellipse(source,pt1,new Size(13,30),10,0,260,new Scalar(0,255,0),3);
		 pt1=new Point(140,140);
		 Imgproc.ellipse(source,pt1,new Size(13,30),70,0,260,new Scalar(0,0,255),3);
		return source;
	}
