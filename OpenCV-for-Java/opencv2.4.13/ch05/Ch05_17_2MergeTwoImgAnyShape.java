   ...
   public class Ch05_17_2MergeTwoImgAnyShape {
      public static void main( String[] args )
      {
         try{
            ...
            Mat source = Highgui.imread("C://opencv3.1//samples//ncku.jpg",Highgui.CV_LOAD_IMAGE_COLOR);
            Mat source1 = Highgui.imread("C://opencv3.1//samples//jelly_studio_logo.jpg",Highgui.CV_LOAD_IMAGE_COLOR);
        ...
        Highgui.imwrite("C://opencv3.1//samples//merge3.jpg", source);
           }catch (Exception e) {
