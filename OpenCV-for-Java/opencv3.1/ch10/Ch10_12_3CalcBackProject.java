...
public class Ch10_12_3CalcBackProject {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch10_12_3CalcBackProject window = new Ch10_12_3CalcBackProject();
	 ...
	 */
	public Ch10_12_3CalcBackProject() {
		initialize();
	...
	private void initialize() {
		...
		frmjavaSwing.setTitle("opencv 反向投影練習3");
	...
	public Mat BackProject(int threshold1){
		int bins=30; 
		 Mat source2 = Imgcodecs.imread("C://opencv3.1//samples//lena.jpg");
		  Mat handle = new Mat();
		  Imgproc.GaussianBlur(source2, source2, new Size(15,15), 0, 0);
		  Imgproc.threshold(source2, source2, threshold1, 255, Imgproc.THRESH_BINARY);//背景太白,3rd用100
