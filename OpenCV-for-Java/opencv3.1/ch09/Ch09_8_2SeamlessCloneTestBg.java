...
public class Ch09_8_2SeamlessCloneTestBg {
	public static void main(String[] args) {
		...
		Mat src3 = Imgcodecs.imread("C://opencv3.1//samples//IloveOpencv-gbg.jpg",Imgcodecs.CV_LOAD_IMAGE_COLOR);
		...
		System.out.println("Photo.MIXED_CLONE="+Photo.MIXED_CLONE);
		 ...
		 Imgcodecs.imwrite("C://opencv3.1//samples//SeamlessClone-MixedClone-iloveCv-testBG.jpg", mixed_clone3);
