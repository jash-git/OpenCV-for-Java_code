...
public class Ch05_4_5NormalizedBlur {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ch05_4_5NormalizedBlur window = new Ch05_4_5NormalizedBlur();
	...
	private void initialize() {
		...
		frmjavaSwing.setTitle("Normalized¼Ò½k½m²ß");
	...
	public Mat BlurFilter(Mat source,int KSize){
         ...
         Imgproc.blur(source, destination, new Size(KSize,KSize));
		return destination;
