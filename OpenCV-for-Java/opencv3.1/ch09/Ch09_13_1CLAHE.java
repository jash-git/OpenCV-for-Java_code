...
public class Ch09_13_1CLAHE {
	...
	private void initialize() {
		final Mat source = Imgcodecs.imread("C://opencv3.1//samples//scene_l.bmp",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
	...
	public Mat CLAHE(double clipLimit,double tileGridSize){
		Mat source = Imgcodecs.imread("C://opencv3.1//samples//scene_l.bmp",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
		 Mat dst=new Mat();
