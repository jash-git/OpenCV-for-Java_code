...
public class Ch03_3_1Arithmetic {
	...
	public static void main(String[] args) {
		...
		System.out.println("m1每個元素的是否在[2,3]區間,Yes=255,No=0:" + inRangeMat.dump());
		...
		//計算2D向量的常度及角度
				...
				System.out.println("矩陣cartToPolar運算,magnitude=" + magnitude.dump()+",angle="+angle.dump());
				...
				System.out.println("求出原2D向量,矩陣polarToCart運算,v1所有元素=" + findM1.dump()+",v2="+findM2.dump());
