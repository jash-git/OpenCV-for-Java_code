...
public class Ch11_9_1UndistortForArt {
	...
	private void initialize() {
		...
		//final Mat source = Imgcodecs.imread("C://opencv249//sources//samples//cpp//005.jpg");
		...
		slider_alpha.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				...
				BufferedImage newImage=matToBufferedImage(matConvertTo(slider_alpha.getValue(),slider_beta.getValue()));
...
public Mat matConvertTo(double alpha,double beta){
		Mat source = Imgcodecs.imread("C://opencv3.1//samples//005.jpg");
		Mat source1 = Imgcodecs.imread("C://opencv3.1//samples//lena.jpg");
        ...
        if (found){
        	...
        	//Imgcodecs.imwrite("C://opencv249//sources//samples//cpp//test-Calib3d-2.jpg", source);
